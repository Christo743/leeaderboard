...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post :create, award: { image: @award.image, is_weekly: @award.is_weekly, name: @award.name, rank: @award.rank }
    end
  ...
  test "should update award" do
    patch :update, id: @award, award: { image: @award.image, is_weekly: @award.is_weekly, name: @award.name, rank: @award.rank }
    assert_redirected_to award_path(assigns(:award))
  end
